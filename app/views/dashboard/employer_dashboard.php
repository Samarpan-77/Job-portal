...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <div class="glass-card metric-card">
            ...
            <p class="metric-value"><?= !empty($profile['company_name']) ? 'Live' : 'Setup' ?></p>
            <a href="<?= base_url('profile') ?>" class="btn btn-outline-primary btn-sm">View Company Page</a>
            <a href="<?= base_url('profile/edit') ?>" class="btn btn-outline-secondary btn-sm mt-2">Edit Company Profile</a>
        </div>
    </div>
</div>
